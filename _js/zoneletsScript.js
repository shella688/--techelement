...
let blogName = "TechElement";
let authorName = "Tech Element";
...
["posts/blog/posts/2025-06-12-Deterring-activity-on-hacking-forums:-Can-we?.html"],
...
["posts/2023-06-07-How-to-make-a-flower-identifying-neural-network-that-won't-kill-you-once-the-robot-uprising-comes.html"],
["posts/2023-04-20-So-You'd-Rather-Throw-Your-Computer-Into-The-Sea-Than-Read-A-Privacy-Policy.html"],
...
'<li><a id="theme-change" onclick="darkMode()">Toggle dark mode</a> </li> </ul>';

//Write the Footer HTML, which has information about the blog.
let footerHTML = "Feel free to share, remix, and reuse this site, just don't take the piss";
...
function formatPostLink(i) {
  ...
  if (  postDateFormat.test ( postsArray[i][0].slice( 6,17 ) ) ) {
    return '<li><a href="' + relativePath + '/'+ postsArray[i][0] +'">' + postsArray[i][0].slice(6,16) + " \u00BB " + postTitle_i + '</a></li><br>';
  } else {
